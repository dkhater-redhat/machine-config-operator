...
FROM registry.ci.openshift.org/ocp/builder:rhel-9-golang-1.22-builder-multi-openshift-4.17 AS rhel9-builder
ARG TAGS=""
...
FROM registry.ci.openshift.org/ocp/builder:rhel-9-golang-1.22-builder-multi-openshift-4.17 AS rhel8-builder
ARG TAGS=""
WORKDIR /go/src/github.com/openshift/machine-config-operator
...
FROM registry.ci.openshift.org/ocp-arm64/4.17-art-latest-arm64:machine-config-operator
ARG TAGS=""
