...
SETUP_ENVTEST_VERSION := $(shell go list -m -json sigs.k8s.io/controller-runtime | jq -r '.Require[] | select(.Path == "sigs.k8s.io/controller-runtime/tools/setup-envtest") | .Version')
